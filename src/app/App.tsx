...
import FinishSettings from './components/FinishSettings'
  ...
  return (
    <main className="shell">
      <header className="cabecalho">
        ...
        <p className="sub">Etiquetas com código de barras a partir do CSV do Bling</p>
      </header>
      ...
      <footer className="rodape">
        Fase 7 de 7 — acabamento. Tudo o que você escolhe fica guardado para a próxima vez.
      </footer>
    </main>
  )
}
